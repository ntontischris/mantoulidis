...
import { useUpdateBenefit } from '@/features/benefits/hooks/useBenefits'
...
interface EditBenefitPageClientProps {
  locale: string
  id: string
  benefit: BenefitRow
}

export function EditBenefitPageClient({ locale, id, benefit }: EditBenefitPageClientProps) {
